...
class FirefighterLogicTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_firefighter_extinguishes_when_two_tiles_away(self) -> None:
        moves: list[tuple[int, str]] = []
        commands: list[tuple[int, OperationId, object | None]] = []
    ...
    async def test_firefighter_passively_roams_when_no_fires_are_known(self) -> None:
        moves: list[tuple[int, str]] = []
